...
const cities: {
  ...
  anchor: "start" | "middle" | "end";
    ...
    { name: "Patna", x: 165, y: 125, label: { x: 175, y: 120 }, anchor: "start" },
    ...
    <div className="relative overflow-hidden p-6 sm:p-10 w-full bg-transparent">
      ...
      <div className="relative flex flex-col items-center justify-center">
        <svg viewBox="-25 -15 350 400" className="w-full max-w-[700px] origin-center lg:scale-110">
          ...
          <g fill="none" stroke="#2563eb" strokeWidth={1.5} strokeLinecap="round">
            {cities.map((city, i) => (
              <path
                key={city.name}
          ...
          {cities.map((city) => (
            <g key={city.name}>
              <circle cx={city.x} cy={city.y} r={5} fill="#1e3a8a" />
              <text
                x={city.label.x}
                y={city.label.y}
                fontSize={13}
